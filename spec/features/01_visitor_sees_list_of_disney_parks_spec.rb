...
feature "visitor sees a list of Disney parks" do
  scenario "sees a list of disney parks and links to park show page" do
    magic_kingdom = Park.create!(name: 'Magic Kingdom', address: '1180 Seven Seas Dr', city: 'Lake Buena Vista', state: 'FL', zip: '32830', description: "meh.")
    animal_kingdom = Park.create!(name: "Animal Kingdom", address: "2901 Osceola Pkwy", city: "Orlando", state: "FL", zip: "32830", description: "meh")
